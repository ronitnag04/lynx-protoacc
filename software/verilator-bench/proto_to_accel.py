...
HEADER_PROLOGUE = """// AUTO-GENERATED by verilator-bench/proto_to_accel.py. Do not edit by hand.
// Source: {src}
...
def emit_source(
    ...
    with out_source.open("w") as f:
        f.write(f'// AUTO-GENERATED by verilator-bench/proto_to_accel.py. Do not edit.\n')
